...
class Metaclass_PumpStatus_Event(type):
    """Metaclass of message 'PumpStatus_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__pump_status__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__pump_status__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__pump_status__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__pump_status__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__pump_status__event
...
class PumpStatus_Event(metaclass=Metaclass_PumpStatus_Event):
    """Message class 'PumpStatus_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mycobot_interfaces/PumpStatus_Request, 1>',
        'response': 'sequence<mycobot_interfaces/PumpStatus_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_interfaces', 'srv'], 'PumpStatus_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_interfaces', 'srv'], 'PumpStatus_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mycobot_interfaces.srv import PumpStatus_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, PumpStatus_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'PumpStatus_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mycobot_interfaces.srv import PumpStatus_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, PumpStatus_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'PumpStatus_Response'"
...
class Metaclass_PumpStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mycobot_interfaces.srv.PumpStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mycobot_interfaces.srv import _pump_status
            ...
            if _pump_status.Metaclass_PumpStatus_Event._TYPE_SUPPORT is None:
                _pump_status.Metaclass_PumpStatus_Event.__import_type_support__()


class PumpStatus(metaclass=Metaclass_PumpStatus):
    from mycobot_interfaces.srv._pump_status import PumpStatus_Request as Request
    from mycobot_interfaces.srv._pump_status import PumpStatus_Response as Response
    from mycobot_interfaces.srv._pump_status import PumpStatus_Event as Event
