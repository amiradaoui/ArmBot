...
#ifndef MYCOBOT_INTERFACES__SRV__DETAIL__PUMP_STATUS__TYPE_SUPPORT_H_
#define MYCOBOT_INTERFACES__SRV__DETAIL__PUMP_STATUS__TYPE_SUPPORT_H_
...
#endif  // MYCOBOT_INTERFACES__SRV__DETAIL__PUMP_STATUS__TYPE_SUPPORT_H_
