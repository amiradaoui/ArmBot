...
mycobot_pro450_interfaces__msg__MycobotSetCoords__create(void)
{
  ...
  mycobot_pro450_interfaces__msg__MycobotSetCoords * msg = (mycobot_pro450_interfaces__msg__MycobotSetCoords *)allocator.allocate(sizeof(mycobot_pro450_interfaces__msg__MycobotSetCoords), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mycobot_pro450_interfaces__msg__MycobotSetCoords));
  bool success = mycobot_pro450_interfaces__msg__MycobotSetCoords__init(msg);
  if (!success) {
...
mycobot_pro450_interfaces__msg__MycobotSetCoords__destroy(mycobot_pro450_interfaces__msg__MycobotSetCoords * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mycobot_pro450_interfaces__msg__MycobotSetCoords__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence__init(mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mycobot_pro450_interfaces__msg__MycobotSetCoords * data = NULL;

  if (size) {
    data = (mycobot_pro450_interfaces__msg__MycobotSetCoords *)allocator.zero_allocate(size, sizeof(mycobot_pro450_interfaces__msg__MycobotSetCoords), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mycobot_pro450_interfaces__msg__MycobotSetCoords__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mycobot_pro450_interfaces__msg__MycobotSetCoords__fini(&data[i - 1]);
      }
...
mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence__fini(mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mycobot_pro450_interfaces__msg__MycobotSetCoords__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * array = (mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence *)allocator.allocate(sizeof(mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence__init(array, size);
  if (!success) {
...
mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence__destroy(mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence__are_equal(const mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * lhs, const mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mycobot_pro450_interfaces__msg__MycobotSetCoords__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mycobot_pro450_interfaces__msg__MycobotSetCoords__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mycobot_pro450_interfaces__msg__MycobotSetCoords);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mycobot_pro450_interfaces__msg__MycobotSetCoords * data =
      (mycobot_pro450_interfaces__msg__MycobotSetCoords *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mycobot_pro450_interfaces__msg__MycobotSetCoords__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mycobot_pro450_interfaces__msg__MycobotSetCoords__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mycobot_pro450_interfaces__msg__MycobotSetCoords__copy(
