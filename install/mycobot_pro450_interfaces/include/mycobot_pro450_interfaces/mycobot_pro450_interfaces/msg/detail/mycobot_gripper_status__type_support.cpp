...
{
  new (message_memory) mycobot_pro450_interfaces::msg::MycobotGripperStatus(_init);
}

void MycobotGripperStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mycobot_pro450_interfaces::msg::MycobotGripperStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MycobotGripperStatus_message_member_array[1] = {
  {
    ...
    offsetof(mycobot_pro450_interfaces::msg::MycobotGripperStatus, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MycobotGripperStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(mycobot_pro450_interfaces::msg::MycobotGripperStatus),
...
{
  return &::mycobot_pro450_interfaces::msg::rosidl_typesupport_introspection_cpp::MycobotGripperStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mycobot_pro450_interfaces, msg, MycobotGripperStatus)() {
  return &::mycobot_pro450_interfaces::msg::rosidl_typesupport_introspection_cpp::MycobotGripperStatus_message_type_support_handle;
}
