...
class Metaclass_GetGripperValue_Event(type):
    """Metaclass of message 'GetGripperValue_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_gripper_value__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_gripper_value__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_gripper_value__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_gripper_value__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_gripper_value__event
...
class GetGripperValue_Event(metaclass=Metaclass_GetGripperValue_Event):
    """Message class 'GetGripperValue_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mycobot_pro450_interfaces/GetGripperValue_Request, 1>',
        'response': 'sequence<mycobot_pro450_interfaces/GetGripperValue_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_pro450_interfaces', 'srv'], 'GetGripperValue_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_pro450_interfaces', 'srv'], 'GetGripperValue_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mycobot_pro450_interfaces.srv import GetGripperValue_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetGripperValue_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetGripperValue_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mycobot_pro450_interfaces.srv import GetGripperValue_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetGripperValue_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetGripperValue_Response'"
...
class Metaclass_GetGripperValue(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_gripper_value.Metaclass_GetGripperValue_Event._TYPE_SUPPORT is None:
                _get_gripper_value.Metaclass_GetGripperValue_Event.__import_type_support__()
...
class GetGripperValue(metaclass=Metaclass_GetGripperValue):
    ...
    from mycobot_pro450_interfaces.srv._get_gripper_value import GetGripperValue_Event as Event
