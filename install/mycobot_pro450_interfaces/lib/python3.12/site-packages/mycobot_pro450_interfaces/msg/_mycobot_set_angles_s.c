...
bool mycobot_pro450_interfaces__msg__mycobot_set_angles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mycobot_pro450_interfaces.msg._mycobot_set_angles.MycobotSetAngles", full_classname_dest, 66) == 0);
  }
  mycobot_pro450_interfaces__msg__MycobotSetAngles * ros_message = _ros_message;
  {  // joint_1
...
{
  /* NOTE(esteve): Call constructor of MycobotSetAngles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mycobot_pro450_interfaces.msg._mycobot_set_angles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MycobotSetAngles");
