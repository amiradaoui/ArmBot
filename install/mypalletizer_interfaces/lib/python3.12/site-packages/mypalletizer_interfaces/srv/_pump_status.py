...
class PumpStatus_Event(metaclass=Metaclass_PumpStatus_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mypalletizer_interfaces/PumpStatus_Request, 1>',
        'response': 'sequence<mypalletizer_interfaces/PumpStatus_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mypalletizer_interfaces', 'srv'], 'PumpStatus_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mypalletizer_interfaces', 'srv'], 'PumpStatus_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mypalletizer_interfaces.srv import PumpStatus_Request
    ...
    def response(self, value):
        if self._check_fields:
            from mypalletizer_interfaces.srv import PumpStatus_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class PumpStatus(metaclass=Metaclass_PumpStatus):
    ...
    from mypalletizer_interfaces.srv._pump_status import PumpStatus_Event as Event
