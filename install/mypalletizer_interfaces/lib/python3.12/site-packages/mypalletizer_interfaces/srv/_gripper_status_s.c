...
ROSIDL_GENERATOR_C_EXPORT
bool mypalletizer_interfaces__srv__gripper_status__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mypalletizer_interfaces.srv._gripper_status.GripperStatus_Event", full_classname_dest, 63) == 0);
  }
  mypalletizer_interfaces__srv__GripperStatus_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!mypalletizer_interfaces__srv__GripperStatus_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mypalletizer_interfaces__srv__GripperStatus_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mypalletizer_interfaces__srv__GripperStatus_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mypalletizer_interfaces__srv__gripper_status__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!mypalletizer_interfaces__srv__GripperStatus_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mypalletizer_interfaces__srv__GripperStatus_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mypalletizer_interfaces__srv__GripperStatus_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mypalletizer_interfaces__srv__gripper_status__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * mypalletizer_interfaces__srv__gripper_status__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mypalletizer_interfaces__srv__gripper_status__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mypalletizer_interfaces__srv__gripper_status__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
