...
// IWYU pragma: private, include "mypalletizer_interfaces/msg/mypal_set_coords.hpp"
...
public:
  ...
  : msg_(msg)
  {}
  ::mypalletizer_interfaces::msg::MypalSetCoords speed(::mypalletizer_interfaces::msg::MypalSetCoords::_speed_type arg)
  {
