...
{
public:
  explicit Init_GetAngles_Event_response(::mypalletizer_interfaces::srv::GetAngles_Event & msg)
  : msg_(msg)
  {}
  ::mypalletizer_interfaces::srv::GetAngles_Event response(::mypalletizer_interfaces::srv::GetAngles_Event::_response_type arg)
  {
...
private:
  ::mypalletizer_interfaces::srv::GetAngles_Event msg_;
};

class Init_GetAngles_Event_request
{
public:
  explicit Init_GetAngles_Event_request(::mypalletizer_interfaces::srv::GetAngles_Event & msg)
  : msg_(msg)
  {}
  Init_GetAngles_Event_response request(::mypalletizer_interfaces::srv::GetAngles_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetAngles_Event_request info(::mypalletizer_interfaces::srv::GetAngles_Event::_info_type arg)
  {
...
template<>
inline
auto build<::mypalletizer_interfaces::srv::GetAngles_Event>()
{
  return mypalletizer_interfaces::srv::builder::Init_GetAngles_Event_info();
}
