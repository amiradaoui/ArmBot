...
{
public:
  explicit Init_GripperStatus_Event_response(::mypalletizer_interfaces::srv::GripperStatus_Event & msg)
  : msg_(msg)
  {}
  ::mypalletizer_interfaces::srv::GripperStatus_Event response(::mypalletizer_interfaces::srv::GripperStatus_Event::_response_type arg)
  {
...
private:
  ::mypalletizer_interfaces::srv::GripperStatus_Event msg_;
};

class Init_GripperStatus_Event_request
{
public:
  explicit Init_GripperStatus_Event_request(::mypalletizer_interfaces::srv::GripperStatus_Event & msg)
  : msg_(msg)
  {}
  Init_GripperStatus_Event_response request(::mypalletizer_interfaces::srv::GripperStatus_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GripperStatus_Event_request info(::mypalletizer_interfaces::srv::GripperStatus_Event::_info_type arg)
  {
...
template<>
inline
auto build<::mypalletizer_interfaces::srv::GripperStatus_Event>()
{
  return mypalletizer_interfaces::srv::builder::Init_GripperStatus_Event_info();
}
