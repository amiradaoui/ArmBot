...
: ${AMENT_CURRENT_PREFIX:="/home/amira/mycobot_ros2/install/mycobot_system_tests"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mycobot_system_tests/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mycobot_system_tests/environment/path.sh"
