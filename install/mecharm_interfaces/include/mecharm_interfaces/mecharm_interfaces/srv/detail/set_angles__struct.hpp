...
// IWYU pragma: private, include "mecharm_interfaces/srv/set_angles.hpp"
...
#ifndef _WIN32
# define DEPRECATED__mecharm_interfaces__srv__SetAngles_Event __attribute__((deprecated))
#else
# define DEPRECATED__mecharm_interfaces__srv__SetAngles_Event __declspec(deprecated)
#endif
...
struct SetAngles_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<mecharm_interfaces::srv::SetAngles_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mecharm_interfaces::srv::SetAngles_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<mecharm_interfaces::srv::SetAngles_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mecharm_interfaces::srv::SetAngles_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<mecharm_interfaces::srv::SetAngles_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mecharm_interfaces::srv::SetAngles_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<mecharm_interfaces::srv::SetAngles_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<mecharm_interfaces::srv::SetAngles_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mecharm_interfaces__srv__SetAngles_Event
    std::shared_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mecharm_interfaces__srv__SetAngles_Event
    std::shared_ptr<mecharm_interfaces::srv::SetAngles_Event_<ContainerAllocator> const>
...
using SetAngles_Event =
  mecharm_interfaces::srv::SetAngles_Event_<std::allocator<void>>;
...
struct SetAngles
{
  ...
  using Event = mecharm_interfaces::srv::SetAngles_Event;
};
