...
enum
{
  mecharm_interfaces__srv__SetCoords_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mecharm_interfaces__srv__SetCoords_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetCoords in the package mecharm_interfaces.
typedef struct mecharm_interfaces__srv__SetCoords_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mecharm_interfaces__srv__SetCoords_Request__Sequence request;
  mecharm_interfaces__srv__SetCoords_Response__Sequence response;
} mecharm_interfaces__srv__SetCoords_Event;

// Struct for a sequence of mecharm_interfaces__srv__SetCoords_Event.
typedef struct mecharm_interfaces__srv__SetCoords_Event__Sequence
{
