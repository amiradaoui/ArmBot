...
[[deprecated("use mecharm_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mecharm_interfaces::srv::SetAngles_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mecharm_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mecharm_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const mecharm_interfaces::srv::SetAngles_Event & msg)
{
  return mecharm_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mecharm_interfaces::srv::SetAngles_Event>()
{
  return "mecharm_interfaces::srv::SetAngles_Event";
}

template<>
inline const char * name<mecharm_interfaces::srv::SetAngles_Event>()
{
  return "mecharm_interfaces/srv/SetAngles_Event";
}

template<>
struct has_fixed_size<mecharm_interfaces::srv::SetAngles_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mecharm_interfaces::srv::SetAngles_Event>
  : std::integral_constant<bool, has_bounded_size<mecharm_interfaces::srv::SetAngles_Request>::value && has_bounded_size<mecharm_interfaces::srv::SetAngles_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<mecharm_interfaces::srv::SetAngles_Event>
  : std::true_type {};
