...
{
public:
  explicit Init_GetAngles_Event_response(::mecharm_interfaces::srv::GetAngles_Event & msg)
  : msg_(msg)
  {}
  ::mecharm_interfaces::srv::GetAngles_Event response(::mecharm_interfaces::srv::GetAngles_Event::_response_type arg)
  {
...
private:
  ::mecharm_interfaces::srv::GetAngles_Event msg_;
};

class Init_GetAngles_Event_request
{
public:
  explicit Init_GetAngles_Event_request(::mecharm_interfaces::srv::GetAngles_Event & msg)
  : msg_(msg)
  {}
  Init_GetAngles_Event_response request(::mecharm_interfaces::srv::GetAngles_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetAngles_Event_request info(::mecharm_interfaces::srv::GetAngles_Event::_info_type arg)
  {
...
template<>
inline
auto build<::mecharm_interfaces::srv::GetAngles_Event>()
{
  return mecharm_interfaces::srv::builder::Init_GetAngles_Event_info();
}
