...
inline std::string to_yaml(const MecharmAngles & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const mecharm_interfaces::msg::MecharmAngles & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mecharm_interfaces::msg::MecharmAngles & msg)
{
