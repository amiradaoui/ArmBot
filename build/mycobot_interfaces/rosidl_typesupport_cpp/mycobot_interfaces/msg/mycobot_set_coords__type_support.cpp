...
static const _MycobotSetCoords_type_support_symbol_names_t _MycobotSetCoords_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_interfaces, msg, MycobotSetCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mycobot_interfaces, msg, MycobotSetCoords)),
  }
};
...
{
  return &::mycobot_interfaces::msg::rosidl_typesupport_cpp::MycobotSetCoords_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mycobot_interfaces, msg, MycobotSetCoords)() {
  return get_message_type_support_handle<mycobot_interfaces::msg::MycobotSetCoords>();
}
