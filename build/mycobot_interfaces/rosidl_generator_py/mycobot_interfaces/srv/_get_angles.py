...
class GetAngles_Event(metaclass=Metaclass_GetAngles_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mycobot_interfaces/GetAngles_Request, 1>',
        'response': 'sequence<mycobot_interfaces/GetAngles_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_interfaces', 'srv'], 'GetAngles_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_interfaces', 'srv'], 'GetAngles_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mycobot_interfaces.srv import GetAngles_Request
    ...
    def response(self, value):
        if self._check_fields:
            from mycobot_interfaces.srv import GetAngles_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetAngles(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mycobot_interfaces.srv.GetAngles')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mycobot_interfaces.srv import _get_angles
...
class GetAngles(metaclass=Metaclass_GetAngles):
    from mycobot_interfaces.srv._get_angles import GetAngles_Request as Request
    from mycobot_interfaces.srv._get_angles import GetAngles_Response as Response
    from mycobot_interfaces.srv._get_angles import GetAngles_Event as Event
