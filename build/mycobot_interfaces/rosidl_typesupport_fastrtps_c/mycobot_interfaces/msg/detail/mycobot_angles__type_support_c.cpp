...
bool cdr_serialize_mycobot_interfaces__msg__MycobotAngles(
  const mycobot_interfaces__msg__MycobotAngles * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mycobot_interfaces
bool cdr_deserialize_mycobot_interfaces__msg__MycobotAngles(
  eprosima::fastcdr::Cdr & cdr,
  mycobot_interfaces__msg__MycobotAngles * ros_message)
{
  // Field name: joint_1
  {
    cdr >> ros_message->joint_1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_interfaces__msg__MycobotAngles;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mycobot_interfaces
bool cdr_serialize_key_mycobot_interfaces__msg__MycobotAngles(
  const mycobot_interfaces__msg__MycobotAngles * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: joint_1
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mycobot_interfaces
size_t get_serialized_size_key_mycobot_interfaces__msg__MycobotAngles(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MycobotAngles__ros_msg_type * ros_message = static_cast<const _MycobotAngles__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mycobot_interfaces
size_t max_serialized_size_key_mycobot_interfaces__msg__MycobotAngles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mycobot_interfaces__msg__MycobotAngles * ros_message = static_cast<const mycobot_interfaces__msg__MycobotAngles *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mycobot_interfaces__msg__MycobotAngles(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mycobot_interfaces__msg__MycobotAngles * ros_message = static_cast<mycobot_interfaces__msg__MycobotAngles *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mycobot_interfaces__msg__MycobotAngles(cdr, ros_message);
}
