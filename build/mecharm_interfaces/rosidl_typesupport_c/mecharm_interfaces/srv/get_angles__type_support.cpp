...
static const _GetAngles_Request_type_support_symbol_names_t _GetAngles_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecharm_interfaces, srv, GetAngles_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecharm_interfaces, srv, GetAngles_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecharm_interfaces, srv, GetAngles_Request)() {
  return &::mecharm_interfaces::srv::rosidl_typesupport_c::GetAngles_Request_message_type_support_handle;
}
...
static const _GetAngles_Response_type_support_symbol_names_t _GetAngles_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecharm_interfaces, srv, GetAngles_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecharm_interfaces, srv, GetAngles_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecharm_interfaces, srv, GetAngles_Response)() {
  return &::mecharm_interfaces::srv::rosidl_typesupport_c::GetAngles_Response_message_type_support_handle;
}
...
static const _GetAngles_Event_type_support_symbol_names_t _GetAngles_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecharm_interfaces, srv, GetAngles_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecharm_interfaces, srv, GetAngles_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecharm_interfaces, srv, GetAngles_Event)() {
  return &::mecharm_interfaces::srv::rosidl_typesupport_c::GetAngles_Event_message_type_support_handle;
}
...
static const _GetAngles_type_support_symbol_names_t _GetAngles_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecharm_interfaces, srv, GetAngles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecharm_interfaces, srv, GetAngles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mecharm_interfaces, srv, GetAngles)() {
  return &::mecharm_interfaces::srv::rosidl_typesupport_c::GetAngles_service_type_support_handle;
}
