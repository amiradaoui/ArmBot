...
// IWYU pragma: private, include "mecharm_interfaces/msg/mecharm_coords.hpp"
...
inline std::string to_yaml(const MecharmCoords & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const mecharm_interfaces::msg::MecharmCoords & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mecharm_interfaces::msg::MecharmCoords & msg)
{
