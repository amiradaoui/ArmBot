...
{
public:
  explicit Init_GetCoords_Event_response(::mecharm_interfaces::srv::GetCoords_Event & msg)
  : msg_(msg)
  {}
  ::mecharm_interfaces::srv::GetCoords_Event response(::mecharm_interfaces::srv::GetCoords_Event::_response_type arg)
  {
...
private:
  ::mecharm_interfaces::srv::GetCoords_Event msg_;
};

class Init_GetCoords_Event_request
{
public:
  explicit Init_GetCoords_Event_request(::mecharm_interfaces::srv::GetCoords_Event & msg)
  : msg_(msg)
  {}
  Init_GetCoords_Event_response request(::mecharm_interfaces::srv::GetCoords_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetCoords_Event_request info(::mecharm_interfaces::srv::GetCoords_Event::_info_type arg)
  {
...
template<>
inline
auto build<::mecharm_interfaces::srv::GetCoords_Event>()
{
  return mecharm_interfaces::srv::builder::Init_GetCoords_Event_info();
}
