...
static const _MecharmSetCoords_type_support_symbol_names_t _MecharmSetCoords_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecharm_interfaces, msg, MecharmSetCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mecharm_interfaces, msg, MecharmSetCoords)),
  }
};
...
{
  return &::mecharm_interfaces::msg::rosidl_typesupport_cpp::MecharmSetCoords_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mecharm_interfaces, msg, MecharmSetCoords)() {
  return get_message_type_support_handle<mecharm_interfaces::msg::MecharmSetCoords>();
}
