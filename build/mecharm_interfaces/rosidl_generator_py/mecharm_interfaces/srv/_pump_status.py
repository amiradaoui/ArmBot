...
class PumpStatus_Event(metaclass=Metaclass_PumpStatus_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mecharm_interfaces/PumpStatus_Request, 1>',
        'response': 'sequence<mecharm_interfaces/PumpStatus_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mecharm_interfaces', 'srv'], 'PumpStatus_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mecharm_interfaces', 'srv'], 'PumpStatus_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mecharm_interfaces.srv import PumpStatus_Request
    ...
    def response(self, value):
        if self._check_fields:
            from mecharm_interfaces.srv import PumpStatus_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_PumpStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mecharm_interfaces.srv.PumpStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mecharm_interfaces.srv import _pump_status
...
class PumpStatus(metaclass=Metaclass_PumpStatus):
    from mecharm_interfaces.srv._pump_status import PumpStatus_Request as Request
    from mecharm_interfaces.srv._pump_status import PumpStatus_Response as Response
    from mecharm_interfaces.srv._pump_status import PumpStatus_Event as Event
