...
bool cdr_serialize_mecharm_interfaces__msg__MecharmCoords(
  const mecharm_interfaces__msg__MecharmCoords * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mecharm_interfaces
bool cdr_deserialize_mecharm_interfaces__msg__MecharmCoords(
  eprosima::fastcdr::Cdr & cdr,
  mecharm_interfaces__msg__MecharmCoords * ros_message)
{
  // Field name: x
  {
    cdr >> ros_message->x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecharm_interfaces__msg__MecharmCoords;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mecharm_interfaces
bool cdr_serialize_key_mecharm_interfaces__msg__MecharmCoords(
  const mecharm_interfaces__msg__MecharmCoords * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: x
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mecharm_interfaces
size_t get_serialized_size_key_mecharm_interfaces__msg__MecharmCoords(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MecharmCoords__ros_msg_type * ros_message = static_cast<const _MecharmCoords__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mecharm_interfaces
size_t max_serialized_size_key_mecharm_interfaces__msg__MecharmCoords(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mecharm_interfaces__msg__MecharmCoords * ros_message = static_cast<const mecharm_interfaces__msg__MecharmCoords *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mecharm_interfaces__msg__MecharmCoords(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mecharm_interfaces__msg__MecharmCoords * ros_message = static_cast<mecharm_interfaces__msg__MecharmCoords *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mecharm_interfaces__msg__MecharmCoords(cdr, ros_message);
}
