...
// IWYU pragma: private, include "mecharm_interfaces/srv/set_angles.h"


#ifndef MECHARM_INTERFACES__SRV__DETAIL__SET_ANGLES__FUNCTIONS_H_
#define MECHARM_INTERFACES__SRV__DETAIL__SET_ANGLES__FUNCTIONS_H_
 ...
 * calls
 * mecharm_interfaces__srv__SetAngles_Request__init().
...
/**
 * It calls
 * mecharm_interfaces__srv__SetAngles_Request__fini()
 ...
 * mecharm_interfaces__srv__SetAngles_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mecharm_interfaces__srv__SetAngles_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mecharm_interfaces__srv__SetAngles_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
...
/**
 * It calls
 * mecharm_interfaces__srv__SetAngles_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mecharm_interfaces__srv__SetAngles_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
...
/**
 * It calls
 * mecharm_interfaces__srv__SetAngles_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * mecharm_interfaces__srv__SetAngles_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mecharm_interfaces__srv__SetAngles_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
...
/**
 * It calls
 * mecharm_interfaces__srv__SetAngles_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mecharm_interfaces__srv__SetAngles_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecharm_interfaces
...
/**
 * It calls
 * mecharm_interfaces__srv__SetAngles_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MECHARM_INTERFACES__SRV__DETAIL__SET_ANGLES__FUNCTIONS_H_
