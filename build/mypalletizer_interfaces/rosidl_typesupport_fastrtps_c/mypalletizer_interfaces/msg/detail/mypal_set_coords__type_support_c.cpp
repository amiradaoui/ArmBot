...
bool cdr_serialize_mypalletizer_interfaces__msg__MypalSetCoords(
  const mypalletizer_interfaces__msg__MypalSetCoords * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
bool cdr_deserialize_mypalletizer_interfaces__msg__MypalSetCoords(
  eprosima::fastcdr::Cdr & cdr,
  mypalletizer_interfaces__msg__MypalSetCoords * ros_message)
{
  // Field name: x
  {
    cdr >> ros_message->x;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
bool cdr_serialize_key_mypalletizer_interfaces__msg__MypalSetCoords(
  const mypalletizer_interfaces__msg__MypalSetCoords * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: x
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
size_t get_serialized_size_key_mypalletizer_interfaces__msg__MypalSetCoords(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MypalSetCoords__ros_msg_type * ros_message = static_cast<const _MypalSetCoords__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
size_t max_serialized_size_key_mypalletizer_interfaces__msg__MypalSetCoords(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mypalletizer_interfaces__msg__MypalSetCoords * ros_message = static_cast<const mypalletizer_interfaces__msg__MypalSetCoords *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mypalletizer_interfaces__msg__MypalSetCoords(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mypalletizer_interfaces__msg__MypalSetCoords * ros_message = static_cast<mypalletizer_interfaces__msg__MypalSetCoords *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mypalletizer_interfaces__msg__MypalSetCoords(cdr, ros_message);
}
