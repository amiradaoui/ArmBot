...
bool cdr_serialize_mypalletizer_interfaces__msg__MypalGripperStatus(
  const mypalletizer_interfaces__msg__MypalGripperStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
bool cdr_deserialize_mypalletizer_interfaces__msg__MypalGripperStatus(
  eprosima::fastcdr::Cdr & cdr,
  mypalletizer_interfaces__msg__MypalGripperStatus * ros_message)
{
  // Field name: status
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mypalletizer_interfaces__msg__MypalGripperStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
bool cdr_serialize_key_mypalletizer_interfaces__msg__MypalGripperStatus(
  const mypalletizer_interfaces__msg__MypalGripperStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
size_t get_serialized_size_key_mypalletizer_interfaces__msg__MypalGripperStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MypalGripperStatus__ros_msg_type * ros_message = static_cast<const _MypalGripperStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
size_t max_serialized_size_key_mypalletizer_interfaces__msg__MypalGripperStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mypalletizer_interfaces__msg__MypalGripperStatus * ros_message = static_cast<const mypalletizer_interfaces__msg__MypalGripperStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mypalletizer_interfaces__msg__MypalGripperStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mypalletizer_interfaces__msg__MypalGripperStatus * ros_message = static_cast<mypalletizer_interfaces__msg__MypalGripperStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mypalletizer_interfaces__msg__MypalGripperStatus(cdr, ros_message);
}
