...
bool cdr_serialize_mypalletizer_interfaces__msg__MypalAngles(
  const mypalletizer_interfaces__msg__MypalAngles * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
bool cdr_deserialize_mypalletizer_interfaces__msg__MypalAngles(
  eprosima::fastcdr::Cdr & cdr,
  mypalletizer_interfaces__msg__MypalAngles * ros_message)
{
  // Field name: joint_1
  {
    cdr >> ros_message->joint_1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mypalletizer_interfaces__msg__MypalAngles;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
bool cdr_serialize_key_mypalletizer_interfaces__msg__MypalAngles(
  const mypalletizer_interfaces__msg__MypalAngles * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: joint_1
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
size_t get_serialized_size_key_mypalletizer_interfaces__msg__MypalAngles(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MypalAngles__ros_msg_type * ros_message = static_cast<const _MypalAngles__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mypalletizer_interfaces
size_t max_serialized_size_key_mypalletizer_interfaces__msg__MypalAngles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mypalletizer_interfaces__msg__MypalAngles * ros_message = static_cast<const mypalletizer_interfaces__msg__MypalAngles *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mypalletizer_interfaces__msg__MypalAngles(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mypalletizer_interfaces__msg__MypalAngles * ros_message = static_cast<mypalletizer_interfaces__msg__MypalAngles *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mypalletizer_interfaces__msg__MypalAngles(cdr, ros_message);
}
