...
static const _GetCoords_Event_type_support_symbol_names_t _GetCoords_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mypalletizer_interfaces, srv, GetCoords_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mypalletizer_interfaces, srv, GetCoords_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mypalletizer_interfaces, srv, GetCoords_Event)() {
  return &::mypalletizer_interfaces::srv::rosidl_typesupport_c::GetCoords_Event_message_type_support_handle;
}
