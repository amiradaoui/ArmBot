...
static const _MypalGripperStatus_type_support_symbol_names_t _MypalGripperStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mypalletizer_interfaces, msg, MypalGripperStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mypalletizer_interfaces, msg, MypalGripperStatus)),
  }
};
...
{
  return &::mypalletizer_interfaces::msg::rosidl_typesupport_cpp::MypalGripperStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mypalletizer_interfaces, msg, MypalGripperStatus)() {
  return get_message_type_support_handle<mypalletizer_interfaces::msg::MypalGripperStatus>();
}
