...
enum
{
  mypalletizer_interfaces__srv__PumpStatus_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mypalletizer_interfaces__srv__PumpStatus_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/PumpStatus in the package mypalletizer_interfaces.
typedef struct mypalletizer_interfaces__srv__PumpStatus_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mypalletizer_interfaces__srv__PumpStatus_Request__Sequence request;
  mypalletizer_interfaces__srv__PumpStatus_Response__Sequence response;
} mypalletizer_interfaces__srv__PumpStatus_Event;

// Struct for a sequence of mypalletizer_interfaces__srv__PumpStatus_Event.
typedef struct mypalletizer_interfaces__srv__PumpStatus_Event__Sequence
{
