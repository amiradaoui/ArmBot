...
[[deprecated("use mypalletizer_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mypalletizer_interfaces::srv::GetAngles_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mypalletizer_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mypalletizer_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const mypalletizer_interfaces::srv::GetAngles_Event & msg)
{
  return mypalletizer_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mypalletizer_interfaces::srv::GetAngles_Event>()
{
  return "mypalletizer_interfaces::srv::GetAngles_Event";
}

template<>
inline const char * name<mypalletizer_interfaces::srv::GetAngles_Event>()
{
  return "mypalletizer_interfaces/srv/GetAngles_Event";
}

template<>
struct has_fixed_size<mypalletizer_interfaces::srv::GetAngles_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mypalletizer_interfaces::srv::GetAngles_Event>
  : std::integral_constant<bool, has_bounded_size<mypalletizer_interfaces::srv::GetAngles_Request>::value && has_bounded_size<mypalletizer_interfaces::srv::GetAngles_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<mypalletizer_interfaces::srv::GetAngles_Event>
  : std::true_type {};
