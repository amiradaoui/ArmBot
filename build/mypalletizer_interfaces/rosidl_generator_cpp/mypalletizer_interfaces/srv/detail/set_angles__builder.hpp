...
{
public:
  explicit Init_SetAngles_Event_response(::mypalletizer_interfaces::srv::SetAngles_Event & msg)
  : msg_(msg)
  {}
  ::mypalletizer_interfaces::srv::SetAngles_Event response(::mypalletizer_interfaces::srv::SetAngles_Event::_response_type arg)
  {
...
private:
  ::mypalletizer_interfaces::srv::SetAngles_Event msg_;
};

class Init_SetAngles_Event_request
{
public:
  explicit Init_SetAngles_Event_request(::mypalletizer_interfaces::srv::SetAngles_Event & msg)
  : msg_(msg)
  {}
  Init_SetAngles_Event_response request(::mypalletizer_interfaces::srv::SetAngles_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetAngles_Event_request info(::mypalletizer_interfaces::srv::SetAngles_Event::_info_type arg)
  {
...
template<>
inline
auto build<::mypalletizer_interfaces::srv::SetAngles_Event>()
{
  return mypalletizer_interfaces::srv::builder::Init_SetAngles_Event_info();
}
