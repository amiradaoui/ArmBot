...
static rosidl_typesupport_introspection_c__MessageMember mypalletizer_interfaces__msg__MypalSetCoords__rosidl_typesupport_introspection_c__MypalSetCoords_message_member_array[5] = {
  {
    "x",  // name
