...
static const _MycobotCoords_type_support_symbol_names_t _MycobotCoords_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mycobot_pro450_interfaces, msg, MycobotCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mycobot_pro450_interfaces, msg, MycobotCoords)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mycobot_pro450_interfaces, msg, MycobotCoords)() {
  return &::mycobot_pro450_interfaces::msg::rosidl_typesupport_c::MycobotCoords_message_type_support_handle;
}
