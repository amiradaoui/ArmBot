...
class Metaclass_GetAngles_Event(type):
    """Metaclass of message 'GetAngles_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_angles__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_angles__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_angles__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_angles__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_angles__event
...
class GetAngles_Event(metaclass=Metaclass_GetAngles_Event):
    """Message class 'GetAngles_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mycobot_pro450_interfaces/GetAngles_Request, 1>',
        'response': 'sequence<mycobot_pro450_interfaces/GetAngles_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_pro450_interfaces', 'srv'], 'GetAngles_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_pro450_interfaces', 'srv'], 'GetAngles_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mycobot_pro450_interfaces.srv import GetAngles_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetAngles_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetAngles_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mycobot_pro450_interfaces.srv import GetAngles_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetAngles_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetAngles_Response'"
...
class Metaclass_GetAngles(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mycobot_pro450_interfaces.srv.GetAngles')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mycobot_pro450_interfaces.srv import _get_angles
            ...
            if _get_angles.Metaclass_GetAngles_Event._TYPE_SUPPORT is None:
                _get_angles.Metaclass_GetAngles_Event.__import_type_support__()


class GetAngles(metaclass=Metaclass_GetAngles):
    from mycobot_pro450_interfaces.srv._get_angles import GetAngles_Request as Request
    from mycobot_pro450_interfaces.srv._get_angles import GetAngles_Response as Response
    from mycobot_pro450_interfaces.srv._get_angles import GetAngles_Event as Event
