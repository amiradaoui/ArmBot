...
class GetCoords_Event(metaclass=Metaclass_GetCoords_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mycobot_pro450_interfaces/GetCoords_Request, 1>',
        'response': 'sequence<mycobot_pro450_interfaces/GetCoords_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_pro450_interfaces', 'srv'], 'GetCoords_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mycobot_pro450_interfaces', 'srv'], 'GetCoords_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mycobot_pro450_interfaces.srv import GetCoords_Request
    ...
    def response(self, value):
        if self._check_fields:
            from mycobot_pro450_interfaces.srv import GetCoords_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetCoords(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mycobot_pro450_interfaces.srv import _get_coords
...
class GetCoords(metaclass=Metaclass_GetCoords):
    from mycobot_pro450_interfaces.srv._get_coords import GetCoords_Request as Request
    from mycobot_pro450_interfaces.srv._get_coords import GetCoords_Response as Response
    from mycobot_pro450_interfaces.srv._get_coords import GetCoords_Event as Event
