...
#include "mycobot_pro450_interfaces/msg/detail/mycobot_gripper_status__rosidl_typesupport_fastrtps_c.h"
...
using _MycobotGripperStatus__ros_msg_type = mycobot_pro450_interfaces__msg__MycobotGripperStatus;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mycobot_pro450_interfaces__msg__MycobotGripperStatus;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mycobot_pro450_interfaces__msg__MycobotGripperStatus * ros_message = static_cast<const mycobot_pro450_interfaces__msg__MycobotGripperStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mycobot_pro450_interfaces__msg__MycobotGripperStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mycobot_pro450_interfaces__msg__MycobotGripperStatus * ros_message = static_cast<mycobot_pro450_interfaces__msg__MycobotGripperStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mycobot_pro450_interfaces__msg__MycobotGripperStatus(cdr, ros_message);
}

static uint32_t _MycobotGripperStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mycobot_pro450_interfaces__msg__MycobotGripperStatus(
...
static size_t _MycobotGripperStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mycobot_pro450_interfaces__msg__MycobotGripperStatus(
